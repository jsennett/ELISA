...
# L1 = Cache(lines=8, words_per_line=4, delay=3, next_level=DRAM, noisy=False, name="L1")
...
# L1 = Cache(lines=8, words_per_line=2, delay=3, next_level=DRAM, noisy=False, associativity=2)
# memory_heirarchy = [L1, DRAM]

# # Two-level cache
# DRAM = Memory(lines=2**8, delay=10, noisy=False)
# L2 = Cache(lines=8, words_per_line=4, delay=3, next_level=DRAM, noisy=False)
# L1 = Cache(lines=8, words_per_line=4, delay=3, next_level=L2, noisy=False)
